...
st.set_page_config(page_title='The Machine Learning', layout='wide')
...
In This implementation, the *RandomForestRegressor()* function function is used in this app for build a regression model using the **Random Forest** algorithm.
